                            ...
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <button type="button" class="btn btn-info add-new" data-toggle="modal"
                                        data-target="#add_banner_modal" onclick="add_promotion_banner()"><i
                                            class="fa fa-plus"></i>
                                        Add
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Promotion Banner</h5>
...
@section('javascript')
    ...
    <script>
        function showBanner(params) {
            $.ajax({
                type: "GET",
                url: "{{ URL::signedRoute('admin.promotion.create') }}",
                dataType: "json",
        ...
        $('#add_banner_btn').click(function(e) {
            ...
            $.ajax({
                url: "{{ URL::signedRoute('admin.promotion.store') }}",
                type: "POST",
                data: data,
                dataType: 'json',
                processData: false,
        ...
        $('#banner_delete-link').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: "{{ URL::signedRoute('admin.promotion.delete_Banner') }}",
                type: "post",
                dataType: 'json',
                data: {
                    "_token": "{{ csrf_token() }}",
