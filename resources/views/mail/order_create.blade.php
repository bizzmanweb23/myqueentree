                                ...
                                <td style="padding-top: 30px;">
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding-bottom: 10px;">
                                                    <a href="{{ route('users.index') }}">
                                                        <img src="{{ asset('asset/image/logo.png') }}" alt="Myqueen"
                                                            width="300" />
                                                    </a>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                                    Los Angeles, Singapore, 90017
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 14px; line-height: 18px; color: #666666;">
                                                    Phone: +6567219257 | Email: admin@xzymyqueen.com
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px; line-height: 18px; color: #666666; padding-bottom: 25px;">
                                                    <strong>Order Number:</strong> {{ $data->order_no }} |
                                                    <strong>Order
                                                        Date:{{ date('d-M-y', strtotime($data->order_date)) }}</strong>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <b
                                                            style="color: #666666;">${{ $item->qun * $item->saleprice }}</b>
                                                        Total
                                                    </td>
                                                </tr>
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    style="font-size: 14px; line-height: 18px; color: #666666;   text-align: right;">
                                ...
                                <td style="padding: 0 10px;">
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="2"
                                                    style="font-size: 16px; font-weight: bold; color: #666666; padding-bottom: 10px;">
                                            ...
                                            <tr>
                                                <td colspan="2"
                                                    ...
                                                    {{-- <b style="font-size: 14px;">Note:</b> Thank You For Order --}}
                                                    <img src="{{ asset('asset/image/Customer-Thank-You-Note-1.png.webp') }}"
                                                        alt="" height="200" width="100%">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
